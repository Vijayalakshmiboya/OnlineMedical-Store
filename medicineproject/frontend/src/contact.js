...
import './signin.css';
import acet from './images/con.webp';
...
function Contact()
{
    ...
    const submitfunction=(e)=>
    {
        ...
        axios.post('http://localhost:5000/contactadd',{contactdata})
        .then((res)=>{
        alert(res.data.msg)})
    }
    return(
...
<Nav.Link as={Link} to="/cart" id="linky"><FaCartPlus style={{height:40,width:45, color:"green"}}/></Nav.Link>
    ...
    <div className="main">
      <div className="cons2">
          <img className="image" src={acet}></img>
      </div>
    <div className="cons">
    <form className="contact1" onSubmit={submitfunction}>
        <label><h5>Full Name :</h5></label>&nbsp;&nbsp;
        <input type="text" name="fullname1" placeholder="Enter your name" onChange={(e)=>contactform({...contactdata,fullname1:e.target.value})}></input>
        <br></br><br></br>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label><h5>Email :</h5></label>&nbsp;&nbsp;
        <input type="email" name="email1" placeholder="Enter Email" onChange={(e)=>contactform({...contactdata,email1:e.target.value})}></input>
        <br></br><br></br>
        &nbsp;&nbsp;<label><h5>Message :</h5></label>&nbsp;&nbsp;&nbsp;
        <input type="textbox"  name="message" onChange={(e)=>contactform({...contactdata,message:e.target.value})}></input>
        <br></br><br></br>
        <center><button id="but"><h5>Submit</h5></button></center>
    </form>
    </div>
